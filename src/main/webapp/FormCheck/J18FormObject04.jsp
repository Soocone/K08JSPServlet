    ...
    <script>
        ...
        var isValidate = function(frm){
            ...
            if(frm.pwd.value != frm.pwd2.value){
                ...
                frm.pwd.value==''; //기존에 입력된 패스워드를 지워준다.
                frm.pwd2.value=='';
                frm.pwd.focus();
                return false;
            }
            /*
            checkbox와 radio는 기본적으로 value 속성값을 가지고 있으므로
            ...
            */
            ...
            for(var i=0; i<frm.gender.length; i++){
                ...
                if(frm.gender[i].checked==true){
                    ...
                    isGender = true;
                    //radio는 하나만 선택이 가능하므로 뒤는 검증할 필요가 없기 때문에 탈출.
                    break; 
                }
            }
            ...
            */
            ...
            /*
            textarea는 자체적인 value속성은 없으나, JS에서 DOM 객체를 통한
            검증을 할 때에는 value 속성을 사용해야 한다.
            */
            if(frm.intro.value == ""){
                alert("자기소개를 선택하세요");
                frm.intro.focus();
        ...
        function idCheck(fn){
            ...
            if(fn.id.value==""){
                ...
                /*
                중복확인창을 띄울때 기존에 입력된 내용을 수정할 수 없도록 id에
                readonly 속성을 추가한다. 만약 수정이 가능한 상태라면 사용자가
                수정할 여지가 있기 때문에 주의가 필요하다.
                */
                fn.id.readOnly = true;
                /*
                부모창에서 입력된 아이디를 팝업창에 파라미터로 전달한다.
