...
<body>
	...
	<%
	//Integer 객체로 저장된 내용을 자동 언박싱 하여 int 형으로 저장함
	//정수 데이터를 객체화할때 Ingeter 클래스를 통해 자동 박싱/언박싱할 수 있다.
	...
	%>
	<ul>
		<!-- Java의 기본클래스인 경우 별도의 처리 없이 즉시 내용을 출력한다. -->
	...
	컴파일을 진행한다. 따라서 동일한 페이지로 취급되므로 page 영역에 그대로 공유된다.
	 -->
